...
import med.voll.medvoll.dtos.paciente.DadosDetalhamentoPaciente;
...
public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemPacientes>> lisar(@PageableDefault(size = 10, sort = { "nome" }, direction = Sort.Direction.ASC) Pageable paginacao) {
